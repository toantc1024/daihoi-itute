...
import AVATAR from "@/assets/background/Ho_Chi_Minh_1946.jpg";
      ...
      <>
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
            {/* Ảnh Bác */}
            <div className="hidden md:block mb-24 md:mb-0 sm:px-6 md:w-1/3">
              ...
              <div className="flex flex-col gap-8">
                ...
                <footer className="mt-6">
                  <div className="flex items-center justify-center">
                    <div className="rounded-xl md:hidden flex-shrink-0">
                      <Image
                        objectFit="cover"
                        src={AVATAR.src}
                        alt="Image Description"
                    ...
                    <div className="ms-4 md:ms-0 text-center">
